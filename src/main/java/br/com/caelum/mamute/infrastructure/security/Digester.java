package br.com.caelum.mamute.infrastructure.security;
...
public class Digester {
    ...
    public static String hashFor(Long id) {
        return encrypt(id.toString()) + new BigInteger("" + (id * 37 + 1)).toString(16);
    }

    public static Long idFor(String hash) {
        // FIXME: Identificar os megic bumber abaixo e criar constantes
